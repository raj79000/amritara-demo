export async function fetchBlogList() {
  const response = await fetch('https://alivaablog.cinuniverse.com/blog-lists.php', {
    method: 'POST',
    headers: {
...
export async function fetchBlogDetail(slug) {
  const response = await fetch('https://alivaablog.cinuniverse.com/blog-detail.php', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function fetchCategoryBlogs(slug) {
  const response = await fetch('https://alivaablog.cinuniverse.com/category-list.php', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
